...
public class Sound : ISound
{
    ...
    private SoundTime cachedSetLength;
    ...
    public SoundTime Length
    {
        get
        {
            ...
            return this.audioDeviceChanging ? this.cachedSetLength : new SoundTime(this.audioBuffer.TotalSeconds);
        }
    }
...
#pragma warning restore CS8524 // The switch expression does not handle some values of its input type (it is not exhaustive) involving an unnamed enum value.
    ...
    private void AudioManager_DeviceChanging(object? sender, EventArgs e)
    {
        ...
        this.cachedSetLength = new SoundTime(this.audioBuffer.TotalSeconds);
